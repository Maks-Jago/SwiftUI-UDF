...
/// Configuration for toast notification behavior and appearance.
///
/// `ToastConfiguration` provides comprehensive control over how toast notifications
...
/// notification = .init(success: "Done!", style: .toast(customConfig))
/// ```
public struct ToastConfiguration: Hashable, Sendable {
    ...
    /// This provides an intuitive way for users to quickly dismiss notifications.
    /// - Default: true
    ...
    /// The maximum width constraint for toast notifications.
    /// 
    ...
    /// The text alignment within toast notifications.
    /// 
...
public extension ToastConfiguration {
    ...
    /// Useful for critical notifications that must be explicitly handled.
    /// 
