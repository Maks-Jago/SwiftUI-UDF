...
/// Shadow styling configuration for toast notifications.
///
/// `ShadowStyle` controls the drop shadow effects applied to toast notifications,
...
public enum ShadowStyle: Hashable, Sendable {
    ...
    /// No shadow effect applied to toast notifications.
    /// 
...
public extension ShadowStyle {
    ...
    /// 
    /// ## Use Cases:
    /// - Critical notifications that need maximum attention
    ...
    /// sparingly for maximum impact notifications.
    /// 
    /// **Configuration:**
