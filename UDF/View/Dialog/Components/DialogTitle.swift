...
///
/// `DialogTitle` is supported in ``AlertDialog`` and ``ConfirmationDialog``, but **not** in ``Toast``.
...
/// }
/// ```
public struct DialogTitle: AlertDialogComponent, ConfirmationDialogComponent {
    let value: String
