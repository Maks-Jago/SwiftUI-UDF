//
//  XReducibleMiddlewareTests.swift
//  
//
...
class XReducibleMiddlewareTests: XCTestCase {
    ...
    class ServiceMiddleware: BaseReducibleMiddleware<AppState> {
        ...
        func reduce(_ action: some Action, for state: XReducibleMiddlewareTests.AppState) {
            switch action {
